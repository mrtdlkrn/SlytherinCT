...
namespace CT.AdminUI.Controllers
{
    public class CarStatusHistoryController : Controller
    {
        ...
        public CarStatusHistoryController(IApiRoutes routes, IApiService apiService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var result = await _apiService.Get<List<ListCarStatusHistoryDTO>>(tokenDTO, _routes["Index"]);
            if (result.Success)
            {                
