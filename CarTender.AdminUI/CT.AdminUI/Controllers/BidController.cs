...
namespace CT.AdminUI.Controllers
{
    public class BidController : Controller
    {
     ...
     ".YqA_0sJDNSXLJzPN8U7bsrzDtfnEEkrwHHT66xx7uix9r270wXo_vZpJsXTZ8WWjdmTmrqhN_4JEdQ41xcisgw",
            ...
            var result = await _apiService.Post(tokenDTO, _routes["Delete"], dto);
            if (result != null)
            {
                //todo: sayfaya veriler basılacak
                return RedirectToAction("Index");
        ...
        public async Task<IActionResult> BidCorporateUser(BidCorporateUserDTO dto)
        {
            ...
            var result = await _apiService.Post(tokenDTO, _routes["BidCorporateUser"], dto);
            if (result != null)
            {
                //todo: sayfaya veriler basılacak
                return View();
        ...
        public async Task<IActionResult> BidInformation(BidInformationDTO dto)
        {
            ...
            var result = await _apiService.Post(tokenDTO, _routes["BidInformation"], dto);
            if (result != null)
            {
                //todo: sayfaya veriler basılacak
                return View();
        ...
        public async Task<IActionResult> BidOfferDetail(BidOfferDetailDTO dto)
        {
            ...
            var result = await _apiService.Post(tokenDTO, _routes["BidOfferDetail"], dto);
            if (result != null)
            {
                //todo: sayfaya veriler basılacak
                return View();
        ...
        public async Task<IActionResult> BidStatusHistory(BidStatusHistoryDTO dto)
        {
            ...
            var result = await _apiService.Post(tokenDTO, _routes["BidStatusHistory"], dto);
            if (result != null)
            {
                //todo: sayfaya veriler basılacak
                return View();
        ...
        public async Task<IActionResult> BidUserOffer(BidUserOfferDTO dto)
        {
            ...
            var result = await _apiService.Post(tokenDTO, _routes["BidUserOffer"], dto);
            if (result != null)
            {
                //todo: sayfaya veriler basılacak
                return View();
        ...
        public async Task<IActionResult> UserAutoBidOffer(BidUserOfferDTO dto) //todo : Yeni bir dto gerekebilir
        {
            ...
            var result = await _apiService.Post(tokenDTO,_routes["UserAutoBidOffer"], dto);
            if (result != null)
            {
                //todo: sayfaya veriler basılacak
                return View();
